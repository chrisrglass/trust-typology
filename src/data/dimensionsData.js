export const DIMENSIONS = [
  ...
  },
  {
    ...
    sharpestSplits: 'Institutional Skeptics (most disengaged); Faith & Freedom Families (AI embeds secular assumptions); Economically Betrayed (hardest hit by entry-level elimination)',
    typeViews: {
      ...
      'market-oriented-pragmatists': 'Views AI as a tool of self-empowerment — one that should be used thoughtfully and ethically and integrated as a core part of college education; wants institutions to teach students how to use AI well, not just manage its risks.',
      'institutional-skeptics': 'Most disengaged on AI — not connecting AI disruption to their higher education calculus.',
      'faith-and-freedom-families': 'Strongest concern about AI and character formation — specifically that AI systems were built without meaningful input from religious traditions, so secular assumptions are not incidental but structural; this is a design-level concern, not a content-moderation complaint.',
